...
export default function OffersPage() {
  ...
  return (
    <div className="min-h-screen bg-[linear-gradient(135deg,#000f08_0%,#214211_30%)] font-hind selection:text-white animate-[gradientMove_18s_ease_infinite] selection:bg-orange-500 pb-24">
      <section className="relative min-h-[450px] lg:min-h-[700px] flex items-center overflow-hidden">
        <div className="absolute inset-0 z-0">
          ...
          <div className="absolute inset-0 bg-gradient-to-b from-transparent to-[#0e270e]/95" />
        </div>
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-10 -mt-16 sm:-mt-20 lg:-mt-24 relative z-20">
          ...
          {offersData.offers.map((offer, index) => (
            ...
            >
              ...
              <div className="p-6 sm:p-8 flex flex-col flex-grow">
                ...
                <div className="w-12 h-1 bg-orange-500 mb-4 group-hover:w-full transition-all duration-700 rounded-full" />
        ...
        {loading ? <p className="text-slate-200 mt-6">Loading offers...</p> : null}
        {error ? <p className="text-red-300 mt-6">{error}</p> : null}
        {!loading && !error && offersData.offers.length === 0 ? (
          <p className="text-slate-200 mt-6">No active offers found.</p>
        ) : null}
      </div>
    </div>
  );
